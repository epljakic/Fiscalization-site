...
CREATE TABLE IF NOT EXISTS `artikal` (
  ...
  `carinska_tarifa` float DEFAULT NULL,
...
(2, 'Mihajlo33', 2, 'Nikole Tesle 7', 6),
(3, 'Mihajlo2', 2, 'Mihajla Pupina 2', 5),
(6, 'Mihajlo101', 2, 'Tutinska 22', 2);
...
('jovan', 1, 'Imlek', 'Srbija', 'Beograd', '11000', 'Mije Kovacevica 7b', '105428306', '20376449', 2, NULL, NULL, 1),
...
CREATE TABLE IF NOT EXISTS `racun` (
  ...
  `licna_karta` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `ime` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `prezime` varchar(40) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
