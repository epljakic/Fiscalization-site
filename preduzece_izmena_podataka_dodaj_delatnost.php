...
<body>
    ...
    require_once('preduzece_izmena_podataka_dodaj_delatnost_provera.php');
    ?>
    ...
    <div id="content">
        ...
        <div id="right_menu">
            ...
            <form name="nova_delatnost" method="POST">
                <table id="tabela_1">
                    <tr>
                        <td colspan="2" id="center">Dodajte novu delatnost:</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td>Delatnost:</td>
                        <td>
                            <select name="delatnost" id="delatnost">
                                <?php
                    ...
                    <tr>
                        <td colspan="2" id="center">
                            <input type="submit" id="dugme_1" name="dodaj_delatnost" value="DODAJ DELATNOST">
                        </td>
                    </tr>
