...
if (isset($_POST['licna_karta'])) {
    ...
    $result3 = mysqli_query($con, "INSERT INTO racun (id_preduzeca, iznos_racuna, iznos_poreza, datum, licna_karta, broj_racuna) VALUES ('" . $row1['id_preduzeca'] . "','" . $iznos_racuna . "','" . $iznos_poreza . "','" . $datum . "','" . $licna_karta . "','" . $slip_racun . "')");
