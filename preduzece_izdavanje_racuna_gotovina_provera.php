...
if (isset($_POST['gotovina'])) {
    ...
    $result3 = mysqli_query($con, "INSERT INTO racun (id_preduzeca, iznos_racuna, iznos_poreza, datum) VALUES ('" . $row1['id_preduzeca'] . "','" . $iznos_racuna . "','" . $iznos_poreza . "','" . $datum . "')");
