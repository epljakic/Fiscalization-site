...
if (!empty($_POST['odaberi'])) {
    ...
    $id_preduzeca = $_POST['id_preduzeca'];
    ...
    $result3 = mysqli_query($con, "INSERT INTO racun (id_preduzeca, iznos_racuna, iznos_poreza, datum, narucilac) VALUES ('" . $row1['id_preduzeca'] . "','" . $iznos_racuna . "','" . $iznos_poreza . "','" . $datum . "','" . $id_preduzeca . "')");
    ...
    if ($result3) {
        ...
        $poruka4 = "<span style='color:red'> Neuspesno izdavanje racuna! </span>";
    }
}
