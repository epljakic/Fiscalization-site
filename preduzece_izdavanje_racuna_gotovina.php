...
<body>
    ...
    require_once('preduzece_izdavanje_racuna_gotovina_provera.php');
    ?>
    ...
    <div id="content">
        ...
        <div id="right_menu">
            <p id="center">Gotovinsko placanje:</p>
            <form name="gotovina" method="POST" onsubmit="return(proverigotovinu())">
                <table id="tabela_1">
                    <tr>
                        <td>Uplacena gotovina:</td>
                        <td><input type="text" name="gotovina"></td>
                    </tr>
                    <tr>
                        <td>Broj licne karte:</td>
                        <td><input type="text" name="licna_karta" placeholder="opciono"></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="center">
                            <input type="submit" id="dugme_1" name="uplata_gotovina" value="NAPLATA">
                        </td>
                    </tr>
                </table>
            </form>
